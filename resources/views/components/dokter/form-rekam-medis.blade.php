...
<script>
    document.getElementById('rekamMedisForm')?.addEventListener('submit', function(e) {
        e.preventDefault();
        ...
        let rekamMedisList = JSON.parse(localStorage.getItem('rekamMedisList') || '[]');
        rekamMedisList.unshift(rekamMedisBaru);
        localStorage.setItem('rekamMedisList', JSON.stringify(rekamMedisList));
        
        alert('✅ Rekam medis berhasil disimpan!');
        
        // Redirect ke daftar rekam medis
        window.location.href = "{{ route('dokter.rekam-medis.index') }}";
    });
